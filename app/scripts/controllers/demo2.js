...
/**
 * @ngdoc function
 * @name genieBubbleApp.controller:AboutCtrl
 * @description
 * # AboutCtrl
...
function createInstructions(i) {
var radius = 75;
	var size = (((i%3)*radius)+radius);
...
function createBall( x, y ) {
	...
	var num_circles = 1;//Math.random() * 10 >> 0;
